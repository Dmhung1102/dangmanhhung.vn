...
if ( isset($_GET['user'])) {
    if (isset($_GET['user'])) {
        $sqlQuery = "SELECT * FROM user as u JOIN blog as b ON u.id = b.userid WHERE userid = $userid ";
    }
            ...
            <div class="row">
                <div class="col-lg-8 px-5">
                    ...
                    <div class="w3-content" style="max-width:800px">
                        <div class="mySlides">
                            <div class="row">
                                <?php  foreach ($dataBlog as $datablogkey => $blogid): ?>
                                    <div class="col-xl-6 col-12 mt-5">
                                        <div class="single-propartes">
                                            <a href="./single_blog.php?id= <?= $blogid['id']?> ">
                                            ...
                                            <div class="propartes-wrap-details p-xl-3 p-4">
                                                <h4>
                                                    <a href="./proparty_details.php"><?= $blogid['title']?></a>
                                                </h4>
                                                <p>
                                                    <?= $blogid['description']?>
                                                </p>
...
<!--                                    <a href="proparty_details.php?id= --><?php //= $propertysell['id']?><!--">-->
<!--                                        <div class="thumbnail mt-2 ">-->
<!--                                            <img src="--><?php //= $propertysell['image']?><!--" >-->
<!--                                        </div>-->
<!--                                    </a>-->
<!---->
<!--                                    <div class="details mt-2">-->
<!--                                        <h5>--><?php //= $propertysell['title'] ?><!--</h5>-->
<!--                                        <ul>-->
<!--                                            <li>-->
<!--                                                <i class="fa-solid fa-location-dot"></i>-->
<!--                                                <p>--><?php //= $propertysell['location']?><!--</p>-->
<!---->
<!--                                            </li>-->
<!--                                        </ul>-->
<!--                                    </div>-->
