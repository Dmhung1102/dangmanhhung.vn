...
if (isset($_POST['dangnhap']))
{
    ...
    if (!$username || !$password) {
        echo "Please enter your full username and password. <a href='javascript: history.go(-1)'>Go Back</a>";
        exit;
    }
    ...
    $query = mysqli_query($conn, "SELECT username, password, id FROM user WHERE username='$username'");
    ...
    if ($password != $row['password']) {
        echo "Incorrect password. Please re-enter. <a href='javascript: history.go(-1)'>Go Back</a>";
        exit;
    }
//    var_dump($row);
    $userid = $row['id'] ;
    ...
    header('Location: http://dangmanhhung.vn/index.php ');
    die();
}
?>
<!DOCTYPE html>
                ...
                <div class="col-md-6 login-box">
                    <form action="login.php?do=login" method="post" class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit" name="dangnhap" class="btn btn-success btn-md" value="Login">
                        </div>
                        ...
                        <div id="register-link" class="d-flex justify-content-center">
                            <p class="text-dark">Not a member?</p>&nbsp;
