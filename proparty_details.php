...
$sqlQueryfloor = "SELECT name FROM housealbum WHERE houseid = $id AND purposeimg = 'floor'";
                        ...
                        <div class="row gx-0 bg-white">
                            <div class="col-md-7 col-12">
                                <div class="product-left pt-3 px-3">
                                    ...
                                    <span><?= $house['area']?>, <?= $house['locationdetails']?>, <?= $house['location']?> </span>
                                    <ul class="mt-2">
                                    ...
                                    <div class="property-amenities mt-5">
                                        <div class="proparty-attachment">
                                            ...
                                            <div class="detailed-price">
                                                ...
                                                <span class="title-price">~<?= round($house['price'] / ($house['width'] * $house['length'])) ?>$ /sqft</span>
                                            </div>
                                            <div class="detailed-area">
                                                <span class="title-price text-secondary">Area</span>
                                                <span class="fw-bold fs-5"><?= $house['width'] * $house['length']?> sqft</span>
                                            </div>
                                            <div class="negotiatied-price">
                                                <span class="title-price text-secondary">Negotiated price</span>
                                                <span class="title-price text-capitalize fs-5 fw-bold"><?= $house['negotiatedprice']?></span>
                                            </div>
                                            <div class="legaldocuments">
                                                <span class="title-price text-secondary">Legal documents</span>
                                                <span class="title-price text-capitalize fs-5 fw-bold">House ownership certificate</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-6">
                                                <ul>
                                                    ...
                                                    <li>All Rooms: <?= $allroom = $house['kitchen'] + $house['bedrooms'] + $house['bathrooms'] + $house['livingroom'] ?></li>
                                    ...
                                    <div class="property-amenities mt-5 row">
                                        ...
                                        <div class="amenities-options">
                                            <ul class="amenities-inner d-flex flex-wrap">
                                                ...
                                                ?>
                                                    <li class="w-25 ">
                                                        <i class="fa-solid fa-check"></i><span class="text-capitalize"><?= $option?></span>
                                                    </li>
                                                <?php endforeach;?>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="addition-details">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4 col-6">
                                                    <ul>
                                                            <li>Remodel Year : <?= $remodelyear = 2023 - $house ['yearbuilding']?></li>
...
<!--                                    </div>-->
                                    <div class="estate-agent-area mt-5">
                                        <div class="property-amenities d-flex">
                                            <div class="circle-avt px-3">
                                                <img class="rounded-circle" src="<?= $dataUser['avt'] ?>" alt="">
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var data = { gallery: [
                    { img: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/953/murra.jpg", alt: "lorem" },
                ]};
