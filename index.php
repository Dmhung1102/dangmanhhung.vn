...
$connect = new PDO("mysql:host=127.0.0.1;dbname=mingrand;charset=utf8",
    "root", "Dmhung1102!");
$sqlQuery = "SELECT a.name as name, a.purposeimg as purposeimg, h.locationdetails as locationdetails, h.location as location, h.yearbuilding as yearbuilding, h.description as description, h.title as title,  h.id as id, h.purpose as purpose, h.price as price, h.bedrooms as bedrooms, h.bathrooms as bathrooms, h.area as area, u.avt as avatar, u.name as username 
            FROM user as u JOIN house as h JOIN housealbum as a ON u.id = h.userid AND h.id =a.houseid WHERE a.purposeimg ='image' ORDER BY h.id LIMIT 3 ";
                    ...
                    <form class="serch-index" action="proparty_list.php" method="get">
                        <div class="col-lg-3 col-4 px-3">
                            <div class="single-select-inner">
                                <select name="locationindex" class="form-select" aria-label="Default select example">
                        ...
                        <div class="col-lg-3 col-4 px-3">
                            <select name="purposeindex" class="form-select" aria-label="Default select example">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-4">
            <div class="single-service-warp">
              ...
              <div class="single-service-details text-center">
                <h4>Family House</h4>
                <p>Lorem ipsum dolor sit consectetur adipisicing elit, sed do eius eiusmod tempor incididunt ut labore.
                </p>
              </div>
            </div>
          </div>
            ...
            <?php foreach ($dataHouse as $datahouseid => $houseid): ?>
                <div class="col-md-4 ">
                    <div class="single-product content">
                        <div class="thumb-img" style="background-image: url('photo/<?= $houseid['name'] ?>')">
                            <a href="./proparty_details.php?id= <?= $houseid['id']?>" class="cat text-capitalize"><?= $houseid['purpose'] ?></a>
                        </div>
                        <div class="product-wrap-details px-3 bottom-0">
                            <div class="media d-flex">
                                <div class="author-besthouse">
                                    <img src="<?= $houseid['avatar'] ?>" alt="Empty" class="w-100 h-75 rounded-circle text-center">
                                </div>
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="section-title text-center">
              ...
              <p>Lorem ipsum dolor amet, consectetur adipisicing elit Lorem ipsum dolor sit amet, consectetur
                adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua eiusmod tempor
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="single-category-wrap content">
              <div class="thumb">
                <img src="https://media.vov.vn/sites/default/files/styles/large/public/2020-10/HN.jpg" alt="">
              </div>
          ...
          <div class="col-md-4">
            <div class="single-category-wrap content">
              <div class="thumb">
                <img src="https://cdnimg.vietnamplus.vn/t870/uploaded/ngtnnn/2022_08_31/ttxvn_3108hoabinh3.jpg" alt="">
              </div>
              <div class="single-category-details">
                <h4>
                  <a>Hoa Binh</a>
          ...
          <div class="col-md-8">
            <div class="single-category-wrap content">
              <div class="thumb">
                <img src="https://www.croatialuxuryrent.com/storage/upload/60b/a84/9d9/thumb-521cd7ab2598d7c7600255ed4c1e7400-ACtC-3dUUhnPukyvA_B6PwqK5wuvQSefQm0xRixxvut1pU3-DTccroA8pzNt6Yvi0UaPGM5YbXPt7YajBpUlEjDYd_g10GKPk_ueHlRlv6ujTvRbWnYdSxcW9wOLsWye-Nw7UVF1yoOOVCh6Wg7QFVRE6-vldw=w1358-h905-no.jpg" alt="">
              </div>
              <div class="single-category-details">
                <h4>
          ...
          <div class="col-md-4 ">
            <div class="single-category-wrap content">
              <div class="thumb">
                <img src="https://berganco.com/wp-content/uploads/2019/12/rental-property-investment-strategy.jpeg" alt="">
              </div>
              <div class="single-category-details">
                <h4>
                  <a>Rental property</a>
          ...
          <div class="first-slider text-center">
            <div class="slider-1">
              <div class="slider1-inner">
                <div class="rounded-circle img-thumb" style="background-image: url('./assets/img/rv-png-1.png');">
                </div>
            ...
            <div class="slider-1">
              <div class="slider1-inner">
                <div class="rounded-circle img-thumb" style="background-image: url('./assets/img/rv-png-2.png');">
                </div>
                <div class="details-thumb">
                  <h6>Sarif Jaya Miprut</h6>
                  <p>“consecte Lorem ipsum dolor sit amet, Lorem ipsum dolor amet, consecte Lorem
      ...
      <div class="container">
        ...
        <div class="rent-sell">
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link" id="pills-sell-tab" data-bs-toggle="pill" data-bs-target="#pills-sell" type="button"
                role="tab" aria-controls="pills-sell" aria-selected="false">Sell</button>
            </li>
          </ul>
        </div>
                        ...
                        <div class="single-propartes">
                            <div class="propartes-img-zoom content ">
                                <a href="./proparty_details.php?id= <?= $purposerent['id']?>">
                                    <?php
                                    echo "<img src='photo/".$purposerent['name']."' >";
                                    ?>
                                </a>
                                <div class="media d-flex px-3">
                                    <div class="author-besthouse">
                                        <img src="<?= $purposerent['avatar']?>"  class="w-100 h-75 rounded-circle text-center">
                                    </div>
                                    <div class="author-in4">
                            ...
                            <div class="propartes-wrap-details p-3 border">
                                ...
                                <ul class="propartes-inner">
                                    <li>
                                        <i class="fa-solid fa-location-dot"></i>
                                        <?= $purposerent['area']?>, <?= $purposerent['locationdetails']?>, <?= $purposerent['location'] ?>
                                    </li>
                                    <li>
                        ...
                        <div class="single-propartes">
                            <div class="propartes-img-zoom content">
                                <a href="./proparty_details.php?id= <?= $purposesell['id']?>">
                                    <?php
                                    echo "<img src='photo/".$purposesell['name']."' >";
                                    ?>
                                </a>
                                <div class="media d-flex px-3">
                                    <div class="author-besthouse">
                                        <img src="<?= $purposesell['avatar']?>" alt="Empty" class="w-100 h-75 rounded-circle text-center">
                                    </div>
                                    <div class="author-in4">
                            ...
                            <div class="propartes-wrap-details p-3 border">
                                ...
                                <ul class="propartes-inner">
                                    <li>
                                        <i class="fa-solid fa-location-dot"></i>
                                        <?= $purposesell['area']?>, <?= $purposesell['locationdetails']?>, <?= $purposesell['location'] ?>
                                    </li>
                                    <li>
        ...
        <div class="row justify-content-center">
          <div class="col-10">
            <div class="section-title text-center">
              ...
              <p>consecte Lorem ipsum dolor sit amet, Lorem ipsum dolor amet, consecte Lorem ipsum dolor sit adipisicing
                amet, consectetur sed do eiusmod tempor incididunt dolore magna consecrem adipisicing ipsum dolor sit
        ...
        <div class="row justify-content-center text-lg-start">
          <div class="col-9 pt-5">
            <div class="section-title">
              ...
              <p>Lorem ipsum dolor amet, consecteLorem ipsum dolor sit amet, consectetur adipisicing sed do eiusmod
                tempor incididunt dolore magna consecteLorem ipsum dolor sit amet, consectetur adipisicing elit,</p>
            </div>
          </div>
          ...
          <div class="row">
              ...
              <div class="blog-wrap-details p-3">
                  <div class="blog-inner d-flex p-0">
                      ...
                      <p><?php  $date = mktime((0), 0, 0, 04, (6 - 1), 2023); echo date('d/m/Y', $date)?></p>
                  </div>
                  <h4 class="mt-2">
          ...
          <div class="row">
            <div class="col-md-4 col-12">
              ...
              <div class="footer-details">
                <p>
                  Lorem ipsum dolor sit amet, Lorem ipsum dolor sit amet, consectetur et adipisicing eiusmod tempor
                  incididunt labore
                </p>
                <p>
                  <i class="fa-solid fa-location-dot"></i>
